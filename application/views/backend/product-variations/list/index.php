...
<div class="container py-5">
    <h4 class="mb-3">
        ...
        <a href="javascript:void(0)" data-url="<?= base_url("panel/product-variations/create-new-product-variation"); ?>" class="btn btn-sm btn-outline-primary rounded-0 float-end createNewProductBtn"> <i class="fa fa-plus"></i> <?= lang("create_new_product_variation") ?></a>
    </h4>
    <form id="filter_form" onsubmit="return false">
        <div class="d-flex flex-wrap">
            ...
            <label for="search_button" class="mx-1">
                <button class="btn btn-sm btn-outline-success rounded-0 " onclick="reloadTable('productVariationTable')" id="search_button" data-bs-toggle="tooltip" data-bs-placement="top" title="<?= lang("search_product") ?>"><i class="fa fa-search"></i></button>
            </label>
        </div>
    </form>
