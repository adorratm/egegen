...
<!-- Bootstrap -->
<script src="<?= base_url("public/js/global/bootstrap.bundle.min.js") ?>"></script>
<!-- #Bootstrap -->

<!-- iziToast -->
<script src="<?= base_url("public/js/global/iziToast.min.js") ?>"></script>
<!-- #iziToast -->

<!-- iziModal -->
<script src="<?= base_url("public/js/global/iziModal.min.js") ?>"></script>
<!-- #iziModal -->

<!-- Sweetalert2 -->
<script src="<?= base_url("public/js/global/sweetalert2.all.min.js") ?>"></script>
<!-- #Sweetalert2 -->
...
<!-- Dropzone -->
<script src="<?= base_url("public/js/backend/dropzone.min.js") ?>"></script>
<!-- #Dropzone -->
...
<!-- Custom JS -->
<script src="<?= base_url("public/js/backend/scripts.js") ?>"></script>
<!-- #Custom JS -->